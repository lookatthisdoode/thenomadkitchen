...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        `
          px-2 text-xl text-left border-b border-slate-300 w-full flex items-center gap-2 ${nunito.className} transition-all hover:underline [&[data-state=open]>svg]:rotate-180`,
        className,
      )}
      {...props}
    >
